...
describe('dist/index.js over stdio: configuration and protocol details', () => {
  ...
  it('answers tools/list with all 20 tools and writes nothing but JSON lines to stdout', async () => {
    ...
    expect(spawned.stderr()).toContain('20 read-only tool(s), 0 mutating tool(s)');
  });
